export const ptBR = {
  ...
  dashboard: {
    ...
    boardMetaDays: (days: number) => `${days} dias`,
    boardSectionTitle: "Reservas por seção",
    boardTitle: "Board de hospedagem",
    checklistTitle: "Checklist",
    createFirstApartment: "Crie o primeiro apartamento",
    emptyReservation: "Nenhuma reserva.",
    ...
    volumeDescription: "Reservas distribuídas por seção do board",
    ical: {
  ...
  apartments: {
    ...
    client: "Cliente",
    clientOwner: "cliente",
    clientsOwned: "De clientes",
    deleteConfirm: "Remover apartamento",
    deleteDescription: (name: string) =>
      `O apartamento ${name} será removido da operação. Use isso apenas quando ele não deve mais aparecer no dashboard.`,
    deleteTitle: "Remover apartamento?",
    editApartment: "Editar apartamento",
    editEyebrow: "Edição",
    empty: "Nenhum apartamento encontrado.",
    icalOptional: "iCal opcional",
    listTitle: "Lista de apartamentos",
    loadFailed: "Falha ao carregar apartamentos.",
    loading: "Carregando apartamentos...",
    manageIcal: "Gerenciar iCal",
    nameField: "Nome do apartamento",
    newEyebrow: "Novo imóvel",
    ...
    owned: "Próprios",
    provider: "Provider",
    realEstateEyebrow: "Imóveis",
    removeFailed: "Falha ao remover apartamento.",
    saveApartment: "Salvar apartamento",
    saveChanges: "Salvar alterações",
    saveFailed: "Falha ao salvar apartamento.",
    saving: "Salvando...",
    searchPlaceholder: "Buscar por imóvel ou proprietário",
  },
} as const;
